...
# purpleLower = np.array([220, 60, 50])#紫
# purpleUpper = np.array([260, 100, 140])
...
while(True):
    ...
    maskRX = cv2.erode(maskR, None, iterations=2)#腐蝕操作
    maskRS = cv2.dilate(maskRX, None, iterations=2)#膨脹操作，其實先腐蝕再膨脹的效果是開運算，去除噪點
